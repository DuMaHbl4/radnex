...
\item 
bool \hyperlink{func_8cpp_a28adcf5511a52ed6897f10d85ec5f511}{vect} (const unsigned int \&x1, const unsigned int \&y1, const unsigned int \&radi, const unsigned int \&x2, const unsigned int \&y2, const unsigned int \&rado, bool cot)
\item 
...
\item 
void \hyperlink{func_8cpp_ad3d705107bb5471b54db773ea8e9a3fc}{frend} (\hyperlink{classuser}{user} $\ast$beg, \hyperlink{classuser}{user} $\ast$p\-U)
...
\hypertarget{func_8cpp_ad3d705107bb5471b54db773ea8e9a3fc}{\index{func.\-cpp@{func.\-cpp}!frend@{frend}}
\index{frend@{frend}!func.cpp@{func.\-cpp}}
\subsubsection[{frend}]{\setlength{\rightskip}{0pt plus 5cm}void frend (
\begin{DoxyParamCaption}
\item[{{\bf user} $\ast$}]{beg, }
\item[{{\bf user} $\ast$}]{p\-U}
\end{DoxyParamCaption}
)}}\label{func_8cpp_ad3d705107bb5471b54db773ea8e9a3fc}
...
\begin{center}
\leavevmode
\includegraphics[width=242pt]{func_8cpp_ad3d705107bb5471b54db773ea8e9a3fc_cgraph}
\end{center}
\end{figure}
...
\begin{center}
\leavevmode
\includegraphics[width=350pt]{func_8cpp_ad3d705107bb5471b54db773ea8e9a3fc_icgraph}
\end{center}
\end{figure}
...
\begin{center}
\leavevmode
\includegraphics[width=238pt]{func_8cpp_ae49e4f4b5d423f5739a1cf8ea5f41f24_cgraph}
\end{center}
\end{figure}
...
\begin{center}
\leavevmode
\includegraphics[height=550pt]{func_8cpp_afae8672ec62ae353f834d7e0e40b6084_cgraph}
\end{center}
\end{figure}
...
\hypertarget{func_8cpp_a28adcf5511a52ed6897f10d85ec5f511}{\index{func.\-cpp@{func.\-cpp}!vect@{vect}}
...
\item[{const unsigned int \&}]{radi, }
\item[{const unsigned int \&}]{x2, }
\item[{const unsigned int \&}]{y2, }
\item[{const unsigned int \&}]{rado, }
\item[{bool}]{cot}
\end{DoxyParamCaption}
)}}\label{func_8cpp_a28adcf5511a52ed6897f10d85ec5f511}
...
\hline
{\em rad1} & -\/ параметр, отвечающий за радиус, в которм пользователь хочет видеть людей \\
\hline
...
\hline
{\em rad2} & -\/ параметр, отвечающий за радиус, в котром пользователь хочет быть видимым для других людей \\
\hline
\end{DoxyParams}
...
\begin{center}
\leavevmode
\includegraphics[width=350pt]{func_8cpp_a28adcf5511a52ed6897f10d85ec5f511_icgraph}
\end{center}
\end{figure}
